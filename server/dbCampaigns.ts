...
const DEFAULT_PACKAGE_TIERS = [
  {
    ...
    isActive: true,
    sortOrder: 1,
    description: "Track up to 15 queries. Up to 120 AI training sessions/month.",
  },
  {
    name: "Growth",
    maxQueries: 5,
    ...
    isActive: true,
    sortOrder: 2,
    description: "Track up to 25 queries. Up to 200 AI training sessions/month.",
  },
  {
    name: "Pro",
    maxQueries: 10,
    ...
    isActive: true,
    sortOrder: 3,
    description: "Track up to 50 queries. Up to 400 AI training sessions/month.",
  },
];
