    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          All queries tracked across campaigns, ranked by AI search volume — showing what real users ask AI platforms
        </p>
      </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              {search ? "No queries match your filter." : "No query data yet. Queries appear after keyword research runs for a campaign."}
            </div>
          ) : (
